...
function onForecastButtonClicked() {
    ...
    var url = getBaseURL() + '/snowbird/snowfall_for_period/start_date/' + today_date + '/end_date/' + ten_days_from_today_date;
...
function onHistoricSnowfallButtonClicked() {
       ...
       var url = getBaseURL() + '/snowbird/snowfall_for_period/start_date/' + start_date + '/end_date/' + end_date;
       fetch(url, {method: 'get'})
       .then((response) => response.json())
       .then(function(response) {
...
function onHighestSnowfallInYearButtonClicked() {
    ...
    var url = getBaseURL() + "/snowbird/snowfall_date/year/" + year;
    fetch(url, {method: 'get'})
    .then((response) => response.json())
    .then(function(response) {
